...
function Experience() {
  return (
    <div className="flex flex-col justify-center w-[90%] lg:w-[70%] bg-gray-700 p-10 rounded-md text-gray-200 gap-6">
      ...
      <div className="flex flex-col gap-6">
        {experience.map(({ id, position, companyName, timeline, details }) => (
          <div className="flex flex-col gap-2" key={id}>
            ...
            <div className="text-sm flex flex-col gap-2 sm:flex-row justify-between">
